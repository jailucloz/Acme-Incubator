...
CREATE TABLE `forum` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKfyiav75cmsy3piffwwesx650x` (`investment_id`),
  CONSTRAINT `FKfyiav75cmsy3piffwwesx650x` FOREIGN KEY (`investment_id`) REFERENCES `investment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_account` VALUES (1,0,_binary '\0','john.doe@acme.com','John','Doe','$2a$05$/a9OsPajzQPfPhT.SnPO1uwf2EgE8W9NoILxsBZCd8YqDHODXBvc.','anonymous'),(3,0,_binary '','administrator@acme.com','Administrator','Acme.com','$2a$05$.KmytIbuvGkoEeh9RuXU1.0Ql6tin7DExRmo7zoGfA5UjKAmiV.fK','administrator');
...
-- Dump completed on 2020-09-02  1:22:14
